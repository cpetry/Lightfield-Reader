#ifndef DEPTHFROMEPIPOLARIMAGES_H
#define DEPTHFROMEPIPOLARIMAGES_H
...
class DepthFromEpipolarImages : public ImageDepth
{
    Q_OBJECT

public:
    DepthFromEpipolarImages(MyGraphicsView* view){
        this->view = view;
    }
    ~DepthFromEpipolarImages(){}
...
#endif // DEPTHFROMEPIPOLARIMAGES_H
